    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        ...
        <div>
            ...
            <p class="mb-0 text-body">
                Perbarui data customer untuk kebutuhan penawaran, invoice, dan order rental.
            </p>
        </div>
        ...
        <div class="d-flex justify-content-between justify-content-md-end align-items-center flex-wrap gap-3">
            ...
            <a
                href="<?= url('customers-show') ?>?id=<?= htmlspecialchars($customer['id']) ?>"
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="pic_name"
                        class="form-control"
                        value="<?= htmlspecialchars($customer['pic_name'] ?? '') ?>"
                    >
                </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="npwp"
                        class="form-control"
                        value="<?= htmlspecialchars($customer['npwp'] ?? '') ?>"
                    >
                </div>
