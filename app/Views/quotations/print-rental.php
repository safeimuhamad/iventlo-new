    ...
    <div class="page">
        ...
        <table class="items">
            <thead>
                <tr>
                    <th width="35">No</th>
                    <th width="320">Produk / Jasa</th>
                    <th width="45">Qty</th>
                    <th width="75">Periode</th>
                    <th width="55">Durasi</th>
            ...
            <tbody>
                <?php if (!empty($items)): ?>
                    <?php foreach ($items as $index => $item): ?>
                        ...
                        <tr>
                            ...
                            <td><?= $periodLabel ?></td>
                            <td><?= htmlspecialchars($item['duration'] ?? 0) ?></td>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="8" style="text-align:center;">Belum ada item.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
